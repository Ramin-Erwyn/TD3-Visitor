...
public final class Main {
    ...
    private AbstactVisitor visiteur;
 public Main(String nomGroupe) {
		this.groupeClient = new GroupeClient(nomGroupe);
 }
 public Main(String nomGroupe, AbstactVisitor v) {
		this(nomGroupe);
 this.visiteur = v;
	}

	public void setVisiteur(AbstactVisitor v) {
 this.visiteur = v;
	}

	public static void main(String[] args) throws Exception {
 	AbstactVisitor xmlVisitor = new XMLRapportCommandes();
	AbstactVisitor printVisitor = new PrintRapportCommandes();
